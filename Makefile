...
# Generated by qmake (3.0) (Qt 5.1.1) on: Fri Nov 15 09:56:05 2013
# Project:  kbplot.pro
# Template: app
...
SOURCES       = src/glwidget.cpp \
		src/main.cpp \
		src/kbplot.cpp \
		src/graphical_object.cpp moc_glwidget.cpp
OBJECTS       = glwidget.o \
		main.o \
		kbplot.o \
		graphical_object.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/kbplot1.0.0/ && $(COPY_FILE) --parents h/aglwidget.h h/glwidget.h h/kbplot.h h/event.h h/graphical_object.h h/txy.h .tmp/kbplot1.0.0/ && $(COPY_FILE) --parents src/glwidget.cpp src/main.cpp src/kbplot.cpp src/graphical_object.cpp .tmp/kbplot1.0.0/ && (cd `dirname .tmp/kbplot1.0.0` && $(TAR) kbplot1.0.0.tar kbplot1.0.0 && $(COMPRESS) kbplot1.0.0.tar) && $(MOVE) `dirname .tmp/kbplot1.0.0`/kbplot1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/kbplot1.0.0
