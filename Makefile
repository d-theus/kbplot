#############################################################################
# Makefile for building: bin/kbplot
# Generated by qmake (3.0) (Qt 5.1.1) on: Thu Dec 5 08:43:40 2013
# Project:  kbplot.pro
# Template: app
# Command: /usr/lib/qt/bin/qmake -o Makefile kbplot.pro
#############################################################################
...
CXXFLAGS      = -pipe -w -DDEBUG -march=x86-64 -mtune=generic -O2 -pipe -fstack-protector --param=ssp-buffer-size=4 -Wall -W -D_REENTRANT -fPIE $(DEFINES)
INCPATH       = -I/usr/lib/qt/mkspecs/linux-g++ -I. -Ih -I/usr/include/qt -I/usr/include/qt/QtOpenGL -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I.
LINK          = g++
LFLAGS        = -Wl,-O1,--sort-common,--as-needed,-z,relro -Wl,-O1
LIBS          = $(SUBLIBS) -L./lib -ldrawtext -lGLU -lGLEW -lQt5OpenGL -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = src/glwidget.cpp \
		...
		src/utilities.cpp moc_glwidget.cpp
OBJECTS       = glwidget.o \
		main.o \
		kbplot.o \
		graphical_object.o \
...
Makefile: kbplot.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/shell-unix.conf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/kbplot1.0.0 || mkdir -p .tmp/kbplot1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/kbplot1.0.0/ && $(COPY_FILE) --parents h/aglwidget.h h/glwidget.h h/kbplot.h h/event.h h/graphical_object.h h/txy.h h/utilities.h .tmp/kbplot1.0.0/ && $(COPY_FILE) --parents src/glwidget.cpp src/main.cpp src/kbplot.cpp src/graphical_object.cpp src/utilities.cpp .tmp/kbplot1.0.0/ && (cd `dirname .tmp/kbplot1.0.0` && $(TAR) kbplot1.0.0.tar kbplot1.0.0 && $(COMPRESS) kbplot1.0.0.tar) && $(MOVE) `dirname .tmp/kbplot1.0.0`/kbplot1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/kbplot1.0.0
...
moc_glwidget.cpp: /usr/include/qt/QtOpenGL/QGLWidget \
...
glwidget.o: src/glwidget.cpp h/glwidget.h \
...
main.o: src/main.cpp h/glwidget.h \
		/usr/include/qt/QtOpenGL/QGLWidget \
		/usr/include/qt/QtOpenGL/qgl.h \
		/usr/include/qt/QtGui/qopengl.h \
		/usr/include/qt/QtCore/qglobal.h \
...
kbplot.o: src/kbplot.cpp h/kbplot.h \
		h/glwidget.h \
		/usr/include/qt/QtOpenGL/QGLWidget \
		/usr/include/qt/QtOpenGL/qgl.h \
		/usr/include/qt/QtGui/qopengl.h \
		...
		/usr/include/qt/QtCore/QDebug \
		h/txy.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o kbplot.o src/kbplot.cpp

graphical_object.o: src/graphical_object.cpp h/graphical_object.h \
		/usr/include/qt/QtCore/QDebug \
		/usr/include/qt/QtCore/qdebug.h \
		/usr/include/qt/QtCore/qalgorithms.h \
		/usr/include/qt/QtCore/qglobal.h \
		...
		/usr/include/qt/QtCore/qcontiguouscache.h \
		h/txy.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o graphical_object.o src/graphical_object.cpp

utilities.o: src/utilities.cpp h/utilities.h \
		h/txy.h
