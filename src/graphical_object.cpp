...
void TextMarkerSet::draw() const
{
	before_draw();
		...
		switch (style.textAlignment) {
			case Style::TEXT_ALIGN_TOP: dy =10.0;
						    break;
			case Style::TEXT_ALIGN_BOTTOM: dy = -10.0;
						       break;
			case Style::TEXT_ALIGN_LEFT: dx = -10.0;
						     break;
			case Style::TEXT_ALIGN_RIGHT: dx = 10.5;
						      break;
			case Style::TEXT_ALIGN_TOPRIGHT: dx = 10.5, dy = 10.5;
							 break;
			case Style::TEXT_ALIGN_BOTLEFT: dx = -10.5, dy = -10.5;
							break;
			case Style::TEXT_ALIGN_BOTRIGHT: dx = 10.5, dy = -10.5;
							 break;
			default:
							 ;
		}
